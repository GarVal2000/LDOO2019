 ...
 */
@WebServlet(urlPatterns = {"/Formu2"})
public class Formu2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Formu2</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Formu2 at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if ("5".equals(control)) {
            ...
            String fechre = request.getParameter("fecharegistro");
            Registrar r = new Registrar();
            r.setNombre(nom);
            
           
            String inj = "INSERT INTO ROOT.INVITADO (NOMBRE, FECHAREG,)"; 
            try  { 
             Class.forName("org.apache.derby.jdbc.ClientDriver");
                con = DriverManager.getConnection("jdbc:derby://localhost:1527/Usuarios","root","root"); 
                stm = con.createStatement();
                stm.executeUpdate(inj+"VALUES ('"+nom+"','"+fechre+"','Invitado')");
            ...
            salida.println("Fecha de Registro: " + request.getParameter("Fecharegistro"));
            
            salida.println("<br><br>");
            
            salida.println("<a href='LoginInvitado.html'>Iniciar sesión</a>");
           ...
           try  { 
             ...
             Class.forName("org.apache.derby.jdbc.ClientDriver");
                con = DriverManager.getConnection("jdbc:derby://localhost:1527/Usuarios","root","root"); 
                stm = con.createStatement();
                rst = stm.executeQuery("select * from ROOT.\"INVITADO\"");
                while(rst.next()){
                    String atrcor = rst.getString("CORREO");
                    String atrcon = rst.getString("FECHAREG");
