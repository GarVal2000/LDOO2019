...
public class Formu extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if ("1".equals(control)) {
            ...
            String inj = "INSERT INTO ROOT.\"tabla\" (NOMBRE, APELLIDO, CORREO, CONTRASENA)"; 
            try  { 
             Class.forName("org.apache.derby.jdbc.ClientDriver");
                con = DriverManager.getConnection("jdbc:derby://localhost:1527/Usuarios","root","root"); 
                stm = con.createStatement();
                stm.executeUpdate(inj+"VALUES ('"+nom+"', '"+apel+"', '"+corre+"', '"+contra+"')");
           ...
           try  { 
             ...
             Class.forName("org.apache.derby.jdbc.ClientDriver");
                con = DriverManager.getConnection("jdbc:derby://localhost:1527/Usuarios","root","root"); 
                stm = con.createStatement();
                rst = stm.executeQuery("select * from ROOT.\"tabla\"");
                while(rst.next()){
                    String atrcor = rst.getString("CORREO");
                    String atrcon = rst.getString("CONTRASENA");
